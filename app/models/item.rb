class Item < ApplicationRecord
  ...
  validates :sipping_cost_id, presence: true, numericality: { other_than: 1, message: "can't be blank" }
  validates :province_id,     presence: true, numericality: { other_than: 1, message: "can't be blank" }
  validates :sipping_day_id,  presence: true, numericality: { other_than: 1, message: "can't be blank" }
